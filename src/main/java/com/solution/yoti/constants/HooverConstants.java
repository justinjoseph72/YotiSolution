package com.solution.yoti.constants;

public class HooverConstants {
    public static final String DATABASE_ERROR = "DATABASE_ERROR";
    public static final String JSON_PARSING_ERROR = "JSON_PARSING_ERROR";
    public static final String ROOM_DIMENSTION_ERROR ="ROOM_DIMENSTION_ERROR";
    public static final String INVALID_ROOM_SIZE ="INVALID_ROOM_SIZE";
